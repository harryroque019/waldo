            ...
            <section id="category-container-section">
                    ...
                    <div class="checkbox-content">
                        ...
                        <div class="checkbox-list">
                            <label class="category-checkbox">
                                <input type="checkbox" value="facial-wash" class="category">
                                <span class="checkbox-title">Facial Wash & Cleanser</span>
                            </label>
                            <label class="category-checkbox">
                                <input type="checkbox" value="moisturizer" class="category">
                                <span class="checkbox-title">Moisturizer & Cream</span>
                            </label>
                            <label class="category-checkbox">
                                <input type="checkbox" value="serum" class="category">
                                <span class="checkbox-title">Serum</span>
                            </label>
                            <label class="category-checkbox">
                                <input type="checkbox" value="sunscreen" class="category">
                                <span class="checkbox-title">Sunscreen</span>
                            </label>
                            <label class="category-checkbox">
                                <input type="checkbox" value="others" class="category">
                                <span class="checkbox-title">Others</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="category-right-panel">
                    <div class="product-content">
                        ...
                        <div class="product-brand-1">

                            <!-- Facial Wash & Cleanser Category --> 
                            ...
                            <!--Moisturizers and Cream Category -->
                        ...
                        <div class="product-brand-2">
                            ...
                            <div class="item moisturizer">
                                ...
                                <div class="product-item-price">
                                    <p class="/imagesuser-1-price">₱ 249</p>
                                </div>
                        ...
                        <div class="pagination">
                            <li class="page-dot-2 active"></li>
                            <li class="page-dot-2"></li>
                            <li class="page-dot-2"></li>
                            <li class="page-dot-2"></li>
                            <li class="page-dot-2"></li>
                        </div>
