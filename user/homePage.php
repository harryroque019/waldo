...
<body>
    ...
    <section id="whyChooseUs">
        <div class="container">
            ...
            <div class="contentImage">
                <img src="../imagesuser/banner/homePageBanner2.png" class="banner2">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="productRangeContent">
                <div class="productContent1">
                     <img src="../imagesuser/banner/facialwashandcleanser.jpg" class="productImage1">
                ...
                <div class="productContent1">
                    <img src="../imagesuser/banner/moisturizersandcreams.jpg" class="productImage1">
                    <div class="titleContent">
                        <h2 class="itemTitle">Moisturizers and Creams</h2>
                    </div>
                    <div class="btnContent">
                        <button class="btnBackground">
                            <a href=""><img src="../imagesuser/svg/arrowIcon.png" class="arrowIcon2"></a>
                        </button>
                    </div>
                </div>

                <div class="productContent1">
                    <img src="../imagesuser/banner/serum.jpg" class="productImage1">
                    <div class="titleContent">
                ...
                <div class="productContent1">
                    <img src="../imagesuser/banner/sunscreen.jpg" class="productImage1">
                    <div class="titleContent">
                ...
                <div class="productContent1">
                    <img src="../imagesuser/banner/toner.jpg" class="productImage1">
                    <div class="titleContent">
                ...
                <div class="productContent1">
                    <img src="../imagesuser/banner/others.jpg" class="productImage1">
                    <div class="titleContent">
    ...
    <section id="moreInfo">
        <div class="container">
            <img src="../imagesuser/banner/homePageBanner3.jpeg" class="banner3">
            <div class="content">
    ...
    <script src="../userjs/homePage.js"></script>
</body>
</html>