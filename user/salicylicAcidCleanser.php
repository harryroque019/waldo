...
<body>
    ...
    <section id="radiance-boost-serum">
        <div class="back-button">
            ...
            <h1>Gentle Salicylic Acid Cleanser</h1>
        </div>
        <div class="container">
            <div class="item-info">
                <div class="product-header">
                    <h1 class="title">Gentle Salicylic Acid Cleanser</h1>
                ...
                <div class="product-information">
                    <p>The Gentle Salicylic Acid Cleanser from Soul Apothecary is designed for those with acne-prone or oily skin. This effective yet gentle formula features salicylic acid to help unclog pores, reduce breakouts, and prevent future blemishes. Its soothing ingredients ensure that the skin remains calm and hydrated, making it suitable for daily use without irritation.</p>
                </div>
            ...
            <div class="item-selection">
                <div class="image-container">
                    <img id="productImage" src="images/product-items/facial-wash/facial-cleanser-4.png">
                </div>
