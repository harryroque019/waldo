...
<body>
    ...
    <section id="radiance-boost-serum">
        <div class="back-button">
            ...
            <h1>Calm + Soothe Oat Cleanser</h1>
        </div>
        <div class="container">
            <div class="item-info">
                <div class="product-header">
                    <h1 class="title">Calm + Soothe Oat Cleanser</h1>
            ...
            <div class="item-selection">
                <div class="image-container">
                    <img id="productImage" src="images/product-items/facial-wash/facial-cleanser-3.png">
                </div>
    ...
    <script src="scripts/sootheOatCleanser.js"></script>
</body>
</html>